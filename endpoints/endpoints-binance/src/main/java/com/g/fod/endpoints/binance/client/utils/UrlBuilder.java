...
public class UrlBuilder {
  ...
  public static final String buildFullUrl(String baseUrl, String urlPath, LinkedHashMap<String, Object> parameters,
    String signature) {
  ...
  public static final StringBuilder joinQueryParameters(StringBuilder urlPath,
