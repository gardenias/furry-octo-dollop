...
import com.g.fod.endpoints.binance.test.usd.impl.utils.JsonWrapperArray;
import com.g.fod.endpoints.binance.test.usd.impl.utils.UrlParamsBuilder;
import com.g.fod.endpoints.binance.test.usd.model.ResponseResult;
import com.g.fod.endpoints.binance.test.usd.model.enums.CandlestickInterval;
import com.g.fod.endpoints.binance.test.usd.model.enums.IncomeType;
...
import com.g.fod.endpoints.binance.test.usd.model.enums.WorkingType;
import com.g.fod.endpoints.binance.test.usd.model.market.AggregateTrade;
import com.g.fod.endpoints.binance.test.usd.model.market.Candlestick;
import com.g.fod.endpoints.binance.test.usd.model.market.CommonLongShortRatio;
import com.g.fod.endpoints.binance.test.usd.model.market.ExchangeFilter;
import com.g.fod.endpoints.binance.test.usd.model.market.ExchangeInfoEntry;
import com.g.fod.endpoints.binance.test.usd.model.market.ExchangeInformation;
import com.g.fod.endpoints.binance.test.usd.model.market.FundingRate;
import com.g.fod.endpoints.binance.test.usd.model.market.LiquidationOrder;
import com.g.fod.endpoints.binance.test.usd.model.market.MarkPrice;
import com.g.fod.endpoints.binance.test.usd.model.market.OpenInterestStat;
import com.g.fod.endpoints.binance.test.usd.model.market.OrderBook;
import com.g.fod.endpoints.binance.test.usd.model.market.OrderBookEntry;
import com.g.fod.endpoints.binance.test.usd.model.market.PriceChangeTicker;
import com.g.fod.endpoints.binance.test.usd.model.market.RateLimit;
import com.g.fod.endpoints.binance.test.usd.model.market.SymbolOrderBook;
import com.g.fod.endpoints.binance.test.usd.model.market.SymbolPrice;
import com.g.fod.endpoints.binance.test.usd.model.market.TakerLongShortStat;
import com.g.fod.endpoints.binance.test.usd.model.market.Trade;
import com.g.fod.endpoints.binance.test.usd.model.trade.AccountBalance;
import com.g.fod.endpoints.binance.test.usd.model.trade.AccountInformation;
import com.g.fod.endpoints.binance.test.usd.model.trade.Asset;
import com.g.fod.endpoints.binance.test.usd.model.trade.Income;
import com.g.fod.endpoints.binance.test.usd.model.trade.Leverage;
import com.g.fod.endpoints.binance.test.usd.model.trade.MyTrade;
import com.g.fod.endpoints.binance.test.usd.model.trade.Order;
import com.g.fod.endpoints.binance.test.usd.model.trade.Position;
import com.g.fod.endpoints.binance.test.usd.model.trade.PositionRisk;
import com.g.fod.endpoints.binance.test.usd.model.trade.WalletDeltaLog;
...
class RestApiRequestImpl {
  ...
  RestApiRequest<List<WalletDeltaLog>> getPositionMarginHistory(String symbolName, int type, long startTime,
  ...
  RestApiRequest<List<OpenInterestStat>> getOpenInterestStat(String symbol, PeriodType period, Long startTime,
    Long endTime, Integer limit) {
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/data/openInterestHist", builder);
  ...
  RestApiRequest<List<CommonLongShortRatio>> getTopTraderAccountRatio(String symbol, PeriodType period, Long startTime,
    Long endTime, Integer limit) {
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/data/topLongShortAccountRatio", builder);
  ...
  RestApiRequest<List<CommonLongShortRatio>> getTopTraderPositionRatio(String symbol, PeriodType period, Long startTime,
    Long endTime, Integer limit) {
    RestApiRequest<List<CommonLongShortRatio>> request = new RestApiRequest<>();
    UrlParamsBuilder builder = UrlParamsBuilder.build()
      .putToUrl("symbol", symbol)
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/data/topLongShortPositionRatio", builder);
  ...
  RestApiRequest<List<CommonLongShortRatio>> getGlobalAccountRatio(String symbol, PeriodType period, Long startTime,
    Long endTime, Integer limit) {
    RestApiRequest<List<CommonLongShortRatio>> request = new RestApiRequest<>();
    UrlParamsBuilder builder = UrlParamsBuilder.build()
      .putToUrl("symbol", symbol)
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/data/globalLongShortAccountRatio", builder);
  ...
  RestApiRequest<List<TakerLongShortStat>> getTakerLongShortRatio(String symbol, PeriodType period, Long startTime,
    Long endTime, Integer limit) {
