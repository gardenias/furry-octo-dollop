...
public class SubAccount {
   ...
   *                   <br><br>
   *                   subAccountString -- mandatory/string -- Please input a string. We will create a virtual email
   *                   using that string for you to register <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- optional/string <br> isFreeze -- optional/string -- true or false <br> page --
   *                   optional/int -- Default value: 1 <br> limit -- optional/int -- Default value: 1, Max value: 200
   *                   <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromEmail -- optional/string <br> toEmail -- optional/string -- true or false <br> startTime --
   *                   optional/long <br> endTime	 -- optional/long <br> page -- optional/int -- Default value: 1 <br>
   *                   limit -- optional/int -- Default value: 1, Max value: 200 <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#query-sub-account-spot-asset-transfer-history-for-master-account">
  ...
  public String spotTransferHistory(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, QUERY_SPOT_TRANSFER_HIST, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string <br> futuresType -- mandatory/long -- 1:USDT-margined Futures,2:
   *                   Coin-margined Futures <br> startTime -- optional/long <br> endTime	 -- optional/long <br> page --
   *                   optional/int -- Default value: 1 <br> limit -- optional/int -- Default value: 1, Max value: 200
   *                   <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#query-sub-account-futures-asset-transfer-history-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromEmail -- mandatory/string -- Sender email <br> toEmail -- mandatory/string -- Recipient
   *                   email
   *                   <br> futuresType -- mandatory/long -- 1:USDT-margined Futures,2: Coin-margined Futures <br>
   *                   asset -- mandatory/string <br> amount -- mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#sub-account-futures-asset-transfer-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub account email <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#sub-account-futures-asset-transfer-for-master-account">
   * https://binance-docs.github.io/apidocs/spot/en/#sub-account-futures-asset-transfer-for-master-account</a>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- optional/string -- Sub account email <br> page -- optional/long -- default 1 <br> size
   *                   -- optional/long -- default 10, max 20 <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#query-sub-account-spot-assets-summary-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub account email <br> coin -- mandatory/string <br> network --
   *                   optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub account email <br> coin -- optional/string <br> status --
   *                   optional/int -- 0(0:pending,6: credited but cannot withdraw, 1:success) <br> startTime --
   *                   optional/long <br> endTime -- optional/long <br> limit -- optional/int <br> offset --
   *                   optional/int -- default:0 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- optional/string -- Sub account email <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-sub-account-39-s-status-on-margin-futures-for-master-account">
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-detail-on-sub-account-39-s-margin-account-for-master-account">
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-summary-of-sub-account-39-s-margin-account-for-master-account">
  ...
  public String marginAccountSummary(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, SUB_ACC_MARGIN_SUMMARY, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-detail-on-sub-account-39-s-futures-account-for-master-account">
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-summary-of-sub-account-39-s-futures-account-for-master-account">
  ...
  public String futuresAccountSummary(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, SUB_ACC_FUTURES_SUMMARY, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-futures-position-risk-of-sub-account-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub-Account email <br> asset -- mandatory/string -- The asset being
   *                   transferred, e.g., USDT <br> amount -- mandatory/deciaml -- The amount to be transferred <br>
   *                   type -- mandatory/int -- 1: transfer from subaccount's spot account to its USDT-margined futures
   *                   account 2: transfer from subaccount's USDT-margined futures account to its spot account 3:
   *                   transfer from subaccount's spot account to its COIN-margined futures account 4:transfer from
   *                   subaccount's COIN-margined futures account to its spot account <br>
   * @return String
  ...
  public String futuresTransfer(LinkedHashMap<String, Object> parameters) {
    ...
    return requestHandler.sendSignedRequest(baseUrl, SUB_ACC_FUTURES_TRANSFER, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   email -- mandatory/string -- Sub-Account email <br> asset -- mandatory/string -- The asset being
   *                   transferred, e.g., USDT <br> amount -- mandatory/deciaml -- The amount to be transferred <br>
   *                   type -- mandatory/int -- 1: transfer from subaccount's spot account to margin account 2: transfer
   *                   from subaccount's margin account to its spot account <br>
   * @return String
  ...
  public String marginTransfer(LinkedHashMap<String, Object> parameters) {
    ...
    ParameterChecker.checkRequiredParameter(parameters, "amount");
    ParameterChecker.checkParameter(parameters, "type", Integer.class);
    return requestHandler.sendSignedRequest(baseUrl, SUB_ACC_MARGIN_TRANSFER, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   toEmail -- mandatory/string -- Sub-Account email <br> asset -- mandatory/string -- The asset
   *                   being transferred, e.g., USDT <br> amount -- mandatory/deciaml -- The amount to be transferred
   *                   <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#transfer-to-sub-account-of-same-master-for-sub-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string -- The asset being transferred, e.g., USDT <br> amount --
   *                   mandatory/deciaml -- The amount to be transferred <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string -- If not sent, result of all assets will be returned <br> type --
   *                   optional/int -- 	1: transfer in, 2: transfer out <br> startTime -- optional/long <br> endTime --
   *                   optional/long <br> limit -- optional/int -- Default 500 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromEmail -- optional/string <br> toEmail -- optional/string <br> fromAccountType --
   *                   mandatory/string -- "SPOT","USDT_FUTURE","COIN_FUTURE" <br> toAccountType -- mandatory/string --
   *                   "SPOT","USDT_FUTURE","COIN_FUTURE" <br> clientTranId -- optional/string -- Must be unique <br>
   *                   asset -- mandatory/string <br> amount -- mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
  ...
  public String universalTransfer(LinkedHashMap<String, Object> parameters) {
    ...
    ParameterChecker.checkParameter(parameters, "asset", String.class);
    ParameterChecker.checkRequiredParameter(parameters, "amount");
    return requestHandler.sendSignedRequest(baseUrl, SUB_UNIVERSAL_TRANSFER, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromEmail -- optional/string <br> toEmail -- optional/string <br> clientTranId -- optional/string
   *                   -- Must be unique <br> startTime -- optional/long <br> endTime -- optional/long <br> page --
   *                   optional/int -- Default 1 <br> limit -- optional/int -- Default 500, Max 500 <br> recvWindow --
   *                   optional/long <br>
   * @return String
  ...
  public String queryUniversalTransfer(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, SUB_UNIVERSAL_TRANSFER, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub-account email <br> futuresType -- mandatory/int -- 1:USDT
   *                   Margined Futures, 2:COIN Margined Futures <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-detail-on-sub-account-39-s-futures-account-v2-for-master-account">
  ...
  public String futuresAccountV2(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "email", String.class);
    ParameterChecker.checkParameter(parameters, "futuresType", Integer.class);
    return requestHandler.sendSignedRequest(baseUrl, SUB_FUTURES_ACCOUNT_V2, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   futuresType -- mandatory/int -- 1:USDT Margined Futures, 2:COIN Margined Futures <br> page --
   *                   optional/int -- 	default:1 <br> limit -- optional/int -- default:10, max:20 <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-summary-of-sub-account-39-s-futures-account-v2-for-master-account">
  ...
  public String futuresAccountSummaryV2(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "futuresType", Integer.class);
    return requestHandler.sendSignedRequest(baseUrl, SUB_FUTURES_ACCOUNT_SUMMARY_V2, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-futures-position-risk-of-sub-account-v2-for-master-account">
  ...
  public String futuresPositionRiskV2(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "email", String.class);
    ParameterChecker.checkParameter(parameters, "futuresType", Integer.class);
    return requestHandler.sendSignedRequest(baseUrl, SUB_FUTURES_POSITION_RISK_V2, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub-account email <br> enableBlvt -- mandatory/boolean -- Only true
   *                   for now <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#enable-leverage-token-for-sub-account-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string -- Sub-account email <br> subAccountApiKey -- mandatory/string <br>
   *                   ipRestrict -- mandatory/boolean -- true or false <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#enable-or-disable-ip-restriction-for-a-sub-account-api-key-for-master-account">
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-ip-restriction-for-a-sub-account-api-key-for-master-account">
  ...
  /**
   * You need to make sure you have used this endpointPOST /sapi/v1/sub-account/subAccountApi/ipRestrictionenabled IP
   * restriction, then you can add IP list by POST /sapi/v1/sub-account/subAccountApi/ipRestriction/ipList.
   * <br><br>
   ...
   *                   <br><br>
   *                   email -- mandatory/string -- Sub-account email <br> subAccountApiKey -- mandatory/string <br>
   *                   ipAddress -- mandatory/string -- Can be added in batches, separated by commas <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#add-ip-list-for-a-sub-account-api-key-for-master-account">
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#delete-ip-list-for-a-sub-account-api-key-for-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   toEmail -- mandatory/string <br> asset -- mandatory/string <br> amount -- mandatory/decimal <br>
   *                   recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#deposit-assets-into-the-managed-sub-account-for-investor-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   email -- mandatory/string <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#query-managed-sub-account-asset-details-for-investor-master-account">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromEmail -- mandatory/string <br> asset -- mandatory/string <br> amount -- mandatory/decimal
   *                   <br> transferDate -- optional/decimal -- Withdrawals is automatically occur on the transfer
   *                   date(UTC0). If a date is not selected, the withdrawal occurs right now <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#withdrawl-assets-from-the-managed-sub-account-for-investor-master-account">
