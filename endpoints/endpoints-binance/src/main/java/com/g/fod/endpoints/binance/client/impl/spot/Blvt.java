...
public class Blvt {
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   tokenName -- mandatory/string -- BTCDOWN, BTCUP <br> cost -- mandatory/decimal -- spot balance
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   tokenName -- optional/string -- BTCDOWN, BTCUP <br> id -- optional/long <br> startTime --
   *                   optional/long <br> endTime -- optional/long <br> limit -- optional/int -- default 1000, max 1000
   *                   <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   tokenName -- mandatory/string -- BTCDOWN, BTCUP <br> amount -- mandatory/decimal -- spot balance
   *                   <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   tokenName -- optional/string -- BTCDOWN, BTCUP <br> recvWindow -- optional/long <br>
   * @return String
