...
public class Wallet {
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   type -- mandatory/string -- "SPOT", "MARGIN", "FUTURES" <br> startTime -- optional/long <br>
   *                   endTime -- optional/long <br> limit -- optional/int -- min 5, max 30, default 5 <br> recvWindow
   *                   -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> withdrawOrderId -- optional/string -- client id for withdraw <br>
   *                   network -- optional/string <br> address -- mandatory/string <br> addressTag -- optional/string --
   *                   Secondary address identifier for coins like XRP,XMR etc. <br> amount -- mandatory/decimal <br>
   *                   transactionFeeFlag -- optional/boolean -- When making internal transfer, true for returning the
   *                   fee to the destination account; false for returning the fee back to the departure account.
   *                   Default false. <br> name -- optional/string -- Description of the address. Space in name should
   *                   be encoded into %20. <br> walletType -- optional/int -- The wallet type for withdraw，0-spot
   *                   wallet ，1-funding wallet.Default spot wallet <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- optional/string <br> status -- optional/int -- 0(0:pending,6: credited but cannot
   *                   withdraw, 1:success) <br> startTime -- optional/long -- Default: 90 days from current timestamp
   *                   <br> endTime -- optional/long -- Default: present timestamp <br> offset -- optional/int --
   *                   Default:0 <br> limit -- optional/int -- Default:1000, Max:1000 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- optional/string <br> status -- optional/int -- 0(0:Email Sent,1:Cancelled 2:Awaiting
   *                   Approval 3:Rejected 4:Processing 5:Failure 6:Completed) <br> startTime -- optional/long --
   *                   Default: 90 days from current timestamp <br> endTime -- optional/long -- Default: present
   *                   timestamp <br> offset -- optional/int <br> limit -- optional/int -- Default:1000, Max:1000 <br>
   *                   recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> network -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   startTime -- optional/long <br> endTime -- optional/long <br> recvWindow -- optional/long <br>
   * @return String
  ...
  public String bnbConvertableAssets(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, BNB_CONVERTABLE_ASSETS, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string <br> startTime -- optional/long <br> endTime -- optional/long <br> limit
   *                   -- optional/int -- Default 20, max 500 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   type -- mandatory/enum <br> asset -- mandatory/string <br> amount -- mandatory/string <br>
   *                   fromSymbol -- optional/string <br> toSymbol -- optional/string <br> recvWindow -- optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   type -- mandatory/enum <br> startTime -- optional/long <br> endTime -- optional/long <br> current
   *                   -- optional/int -- Default 1 <br> size -- optional/int -- 	Default 10, Max 100 <br> fromSymbol --
   *                   optional/string <br> toSymbol -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string <br> needBtcValuation -- optional/string -- true or false <br>
   *                   recvWindow -- optional/long <br>
   * @return String
