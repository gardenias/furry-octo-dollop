...
public class Fiat {
   ...
   *                   <br><br>
   *                   transactionType -- mandatory/string -- 0-deposit,1-withdraw <br> beginTime -- optional/long <br>
   *                   endTime -- optional/long <br> page -- optional/int -- default 1 <br> rows -- optional/int --
   *                   default 100, max 500 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   transactionType -- mandatory/string -- 0-buy,1-sell <br> beginTime -- optional/long <br> endTime
   *                   -- optional/long <br> page -- optional/int -- default 1 <br> rows -- optional/int -- default 100,
   *                   max 500 <br> recvWindow -- optional/long <br>
   * @return String
