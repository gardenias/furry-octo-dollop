...
public class GiftCard {
   ...
   * <p>
   * You have a Binance account <br> You have passed kyc <br> You have a sufﬁcient balance in your Binance funding
   * wallet <br> You need Enable Withdrawals for the API Key which requests this endpoint. <br>
   * <br><br>
   ...
   *                   <br><br>
   *                   token -- mandatory/string -- The coin type contained in the Binance Code <br> amount --
   *                   mandatory/double -- The amount of the coin <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   code -- mandatory/string -- Binance code <br> recvWindow -- optional/long <br>
   * @return String
   ...
   * <br> Please note that if you enter the wrong binance code 5 times within an hour, you will no longer be able to
   * verify any binance code for that hour. <br>
   * <br><br>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   referenceNo -- mandatory/string -- reference number <br> recvWindow -- optional/long <br>
   * @return String
