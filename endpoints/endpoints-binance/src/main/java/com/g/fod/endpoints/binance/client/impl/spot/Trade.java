...
public class Trade {
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> side -- mandatory/enum <br> type -- mandatory/enum <br>
   *                   timeInForce -- optional/enum <br> quantity -- optional/decimal <br> quoteOrderQty --
   *                   optional/decimal <br> price -- optional/decimal <br> newClientOrderId -- optional/string <br>
   *                   stopPrice -- optional/decimal <br> icebergQty -- optional/deciaml <br> newOrderRespType --
   *                   optional/enum <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> orderId -- optional/long <br> origClientOrderId --
   *                   optional/string <br> newClientOrderId -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a href="https://binance-docs.github.io/apidocs/spot/en/#cancel-order-trade">
   * https://binance-docs.github.io/apidocs/spot/en/#cancel-order-trade</a>
   */
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> orderId -- optional/long <br> startTime -- optional/long <br>
   *                   endTime -- optional/long <br> limit -- optional/int <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> listClientOrderId -- optional/string <br> side -- mandatory/enum
   *                   <br> quantity -- mandatory/decimal <br> limitClientOrderId -- optional/string <br> price --
   *                   mandatory/decimal <br> limitIcebergQty -- optional/decimal <br> stopClientOrderId --
   *                   optional/string <br> stopPrice -- mandatory/decimal <br> stopLimitPrice -- optional/decimal <br>
   *                   stopIcebergQty -- optional/deciaml <br> stopLimitTimeInForce -- optional/enum <br>
   *                   newOrderRespType -- optional/enum <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a href="https://binance-docs.github.io/apidocs/spot/en/#new-order-trade">
   * https://binance-docs.github.io/apidocs/spot/en/#new-order-trade</a>
   */
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> orderListId -- optional/string <br> listClientOrderId --
   *                   optional/string <br> newClientOrderId -- optional/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   orderListId -- optional/string <br> origClientOrderId -- optional/string <br> recvWindow --
   *                   optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   fromId -- optional/long <br> startTime -- optional/long <br> endTime -- optional/long <br> limit
   *                   -- optional/int <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a href="https://binance-docs.github.io/apidocs/spot/en/#query-oco-user_data">
   * https://binance-docs.github.io/apidocs/spot/en/#query-oco-user_data</a>
   */
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> orderId -- optional/long <br> startTime -- optional/long <br>
   *                   endTime -- optional/long <br> fromId -- optional/long <br> limit -- optional/int <br> recvWindow
   *                   -- optional/long <br>
   * @return String
