...
public class Futures {
   ...
   *                   spot account to USDT-M futures account. 2: transfer from USDT-M futures account to spot account.
   *                   3: transfer from spot account to COIN-M futures account. 4: transfer from COIN-M futures account
   *                   to spot account. <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string -- The asset being transferred, e.g. USDT <br> startTime --
   *                   mandatory/long <br> endTime -- optional/long <br> current -- optional/long -- Currently querying
   *                   page. Start from 1. Default:1 <br> size -- optional/long -- Default:10 Max:100 <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-future-account-transaction-history-list-user_data">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> amount -- mandatory/decimal -- when collateralAmount is empty <br>
   *                   collateralCoin -- mandatory/string <br> collateralAmount -- mandatory/decimal -- when amount is
   *                   empty <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- optional/string <br> startTime -- optional/long <br> endTime -- optional/long <br> limit
   *                   -- optional/long -- default 500, max 1000 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> collateralCoin -- mandatory/string <br> amount --
   *                   mandatory/decimal
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   loanCoin -- optional/string <br> collateralCoin -- optional/long <br> recvWindow --
   *                   optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   loanCoin -- mandatory/string <br> collateralCoin -- mandatory/string <br> amount --
   *                   mandatory/decimal <br> direction -- mandatory/enum -- "ADDITIONAL", "REDUCED" <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#calculate-rate-after-adjust-cross-collateral-ltv-v2-user_data">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   loanCoin -- mandatory/string <br> collateralCoin -- mandatory/string <br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-max-amount-for-adjust-cross-collateral-ltv-v2-user_data">
  ...
  public String calcMaxAdjustAmount(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "loanCoin", String.class);
    ParameterChecker.checkParameter(parameters, "collateralCoin", String.class);
    return requestHandler.sendSignedRequest(baseUrl, CALCU_MAX_ADJUST_AMOUNT, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   loanCoin -- optional/string <br> collateralCoin -- optional/string <br> startTime --
   *                   optional/long <br> endTime -- optional/long <br> limit -- optional/long -- default 500, max 1000
   *                   <br> recvWindow -- optional/long <br>
   * @return String
  ...
  public String adjustCollateralHistory(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, ADJUST_COLLATERAL_HISTORY, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> collateralCoin -- mandatory/string <br> recvWindow --
   *                   optional/long
   *                   <br>
   * @return String
  ...
  public String collateralRepayLimit(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "coin", String.class);
    ParameterChecker.checkParameter(parameters, "collateralCoin", String.class);
    return requestHandler.sendSignedRequest(baseUrl, COLLATERAL_REPAY_LIMIT, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   coin -- mandatory/string <br> collateralCoin -- mandatory/string <br> amount -- mandatory/decimal
   *                   -- repay amount <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   quoteId -- mandatory/string <br> recvWindow -- optional/long <br>
   * @return String
  ...
  public String collateralRepayResult(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "quoteId", String.class);
    return requestHandler.sendSignedRequest(baseUrl, COLLATERAL_REPAY_RESULT, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   collateralCoin -- optional/string <br> startTime -- optional/long <br> endTime -- optional/long
   *                   <br> current -- optional/long -- Currently querying page. Start from 1. Default:1 <br> limit --
   *                   optional/long -- default 500, max 1000 <br> recvWindow -- optional/long <br>
   * @return String
