 ...
 * @see ""
 */
public class CancelReplaceEndpoint extends AbstractBinanceRESTEndpoint<AccountInfoReq, AccountInfoResp> {

  public CancelReplaceEndpoint(WebClient webClient, SignatureProducer signatureProducer) {
    super(webClient, signatureProducer, "/api/v3/openOrders", HttpMethod.GET);
  }
