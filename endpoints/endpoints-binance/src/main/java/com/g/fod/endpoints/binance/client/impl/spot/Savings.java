...
public class Savings {
   ...
   *                   <br><br>
   *                   status -- optional/enum -- "ALL", "SUBSCRIBABLE", "UNSUBSCRIBABLE"; Default: "ALL" <br> featured
   *                   -- optional/string -- "ALL", "TRUE"; Default: "ALL" <br> current -- optional/long -- Current
   *                   query page. Default: 1, Min: 1 <br> size -- optional/long -- Default: 50, Max: 100 <br>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   productId -- mandatory/string<br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-left-daily-purchase-quota-of-flexible-product-user_data">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   productId -- mandatory/string<br> amount -- mandatory/decimal<br> recvWindow -- optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   productId -- mandatory/string<br> type -- mandatory/enum -- "FAST", "NORMAL"<br> recvWindow --
   *                   optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#get-left-daily-redemption-quota-of-flexible-product-user_data">
  ...
  public String dailyRedemptionQuota(LinkedHashMap<String, Object> parameters) {
    ...
    return requestHandler.sendSignedRequest(baseUrl, DAILY_REDEMPTION_QUOTA, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   productId -- mandatory/string<br> amount -- mandatory/decimal<br> type -- mandatory/enum --
   *                   "FAST", "NORMAL"<br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string<br> type -- mandatory/enum -- "ACTIVITY", "CUSTOMIZED_FIXED" <br> status
   *                   -- optional/enum -- "ALL", "SUBSCRIBABLE", "UNSUBSCRIBABLE"; default "ALL" <br> isSortAsc --
   *                   optional/boolean -- default "true" <br> sortBy -- optional/enum -- "START_TIME", "LOT_SIZE",
   *                   "INTEREST_RATE", "DURATION"; default "START_TIME" <br> current -- optional/long -- Currently
   *                   querying page. Start from 1. Default:1 <br> size -- optional/long -- Default:10, Max:100 <br>
   *                   recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   projectId -- mandatory/string <br> lot -- mandatory/long <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string <br> projectId -- optional/string <br> status -- optional/enum --
   *                   "HOLDING", "REDEEMED" <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   lendingType -- mandatory/enum -- "DAILY" for flexible, "ACTIVITY" for activity,
   *                   "CUSTOMIZED_FIXED" for fixed <br> asset -- optional/string <br> startTime -- optional/long <br>
   *                   endTime -- optional/long <br> current -- optional/long -- Currently querying page. Start from 1.
   *                   Default:1 <br> size -- optional/long -- Default:10, Max:100 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   projectId -- mandatory/string <br> lot -- mandatory/long <br> positionId -- optional/long -- for
   *                   fixed position <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#change-fixed-activity-position-to-daily-position-user_data">
  ...
  public String changeToDailyPosition(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "projectId", String.class);
    ParameterChecker.checkParameter(parameters, "lot", Long.class);
    return requestHandler.sendSignedRequest(baseUrl, CHANGE_TO_DAILY_POSITION, parameters, HttpMethod.POST,
      showLimitUsage);
  }
}
