...
public class Mining {
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   algo -- mandatory/string -- sha256 <br> userName -- mandatory/string -- Mining account <br>
   *                   workerName -- mandatory/string -- Miner's name(required) <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   <br><br>
   *                   algo -- mandatory/string -- sha256 <br> userName -- mandatory/string -- Mining account <br>
   *                   pageIndex -- optional/int -- Page number,default is first page,start form 1 <br> sort --
   *                   optional/int -- sort sequence(default=0)0 positive sequence, 1 negative sequence <br> sortColumn
   *                   -- optional/int -- Sort by( default 1): 1: miner name, 2: real-time computing power, 3: daily
   *                   average computing power, 4: real-time rejection rate, 5: last submission time <br> workerStatus
   *                   -- optional/int -- miners status(default=0)0 all,1 valid,2 invalid,3 failure <br> recvWindow --
   *                   optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   algo -- mandatory/string -- sha256 <br> userName -- mandatory/string -- Mining account <br> coin
   *                   -- optional/string <br> startDate -- optional/long -- Search date, millisecond timestamp, while
   *                   empty query all	 <br> endDate -- optional/long -- Search date, millisecond timestamp, while empty
   *                   query all <br> pageIndex -- optional/int -- Page number, empty default first page, starting from
   *                   1 <br> pageSize -- optional/int -- 	Number of pages, minimum 10, maximum 200 <br> recvWindow --
   *                   optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   pageIndex -- optional/int -- Page number, empty default first page, starting from 1 <br> pageSize
   *                   -- optional/int -- 	Number of pages, minimum 10, maximum 200 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   configId -- mandatory/int -- Mining ID <br> userName -- mandatory/string -- Mining Account <br>
   *                   pageIndex -- optional/int -- Page number, empty default first page, starting from 1 <br> pageSize
   *                   -- optional/int -- 	Number of pages, minimum 10, maximum 200 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
  ...
  public String hashrateResaleDetail(LinkedHashMap<String, Object> parameters) {
    ...
    ParameterChecker.checkParameter(parameters, "userName", String.class);
    return requestHandler.sendSignedRequest(baseUrl, HASHRATE_RESALE_DETAIL, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   userName -- mandatory/string -- Mining Account <br> algo -- mandatory/string -- Transfer
   *                   algorithm(sha256) <br> endDate -- mandatory/long -- Resale End Time (Millisecond timestamp) <br>
   *                   startDate -- mandatory/long -- Resale Start Time(Millisecond timestamp) <br> toPoolUser --
   *                   mandatory/string -- Mining Account <br> hashRate -- mandatory/long -- Resale hashrate h/s must be
   *                   transferred (BTC is greater than 500000000000 ETH is greater than 500000) <br> recvWindow --
   *                   optional/long <br>
   * @return String
  ...
  public String hashrateResaleRequest(LinkedHashMap<String, Object> parameters) {
    ...
    return requestHandler.sendSignedRequest(baseUrl, HASHRATE_RESALE_REQUEST, parameters, HttpMethod.POST,
      showLimitUsage);
  }
  ...
  public String cancelHashrateResaleConfig(LinkedHashMap<String, Object> parameters) {
    ParameterChecker.checkParameter(parameters, "configId", Integer.class);
    ParameterChecker.checkParameter(parameters, "userName", String.class);
    return requestHandler.sendSignedRequest(baseUrl, CANCEL_HASHRATE_RESALE_CONFIG, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   algo -- mandatory/string -- Algorithm(sha256) <br> userName -- mandatory/string -- Mining
   *                   Account
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   algo -- mandatory/string -- Algorithm(sha256) <br> startDate -- optional/long -- Millisecond
   *                   timestamp <br> endDate -- optional/long -- Millisecond timestamp <br> pageIndex -- optional/int
   *                   -- Default 1 <br> pageSize -- optional/int -- 	Min 10,Max 200 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
