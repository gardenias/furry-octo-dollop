...
import com.g.fod.endpoints.binance.client.utils.JSONParser;
...
public class Market {
   ...
   *                   <br><br>
   *                   symbol -- optional/string <br> symbols -- optional/string
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> limit -- optional/integer -- limit the results Default 100; max
   *                   5000. Valid limits:[5, 10, 20, 50, 100, 500, 1000, 5000] <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> limit -- optional/integer -- limit the results Default 500; max
   *                   1000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> limit -- optional/integer -- limit the result Default 500; max
   *                   1000 <br> fromId -- optional/long -- trade id to fetch from. Default gets most recent trades
   *                   <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> fromId -- optional/long -- id to get aggregate trades from
   *                   INCLUSIVE <br> startTime -- optional/long -- Timestamp in ms to get aggregate trades from
   *                   INCLUSIVE <br> endTime -- optional/long -- Timestamp in ms to get aggregate trades until
   *                   INCLUSIVE <br> limit -- optional/integer -- limit the results Default 500; max 1000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> interval -- mandatory/string <br> startTime -- optional/long <br>
   *                   endTime -- optional/long <br> limit -- optional/integer -- limit the results Default 500; max
   *                   1000 <br>
   * @return String
