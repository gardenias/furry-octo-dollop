...
public class Margin {
   ...
   *                   <br><br>
   *                   asset -- mandatory/string -- The asset being transferred, e.g., BTC <br> amount --
   *                   mandatory/decimal -- The amount to be transferred <br> type -- mandatory/int -- 1: transfer from
   *                   main account to cross margin account 2: transfer from cross margin account to main account <br>
  ...
  public String crossMarginTransfer(LinkedHashMap<String, Object> parameters) {
    ...
    return requestHandler.sendSignedRequest(baseUrl, CROSS_MARGIN_TRANSFER, parameters, HttpMethod.POST,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> symbol -- optional/string -- isolated symbol <br> amount --
   *                   mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> side -- mandatory/enum <br> type -- mandatory/enum <br>
   *                   quantity -- optional/decimal <br> quoteOrderQty -- optional/decimal <br> price --
   *                   optional/decimal <br> stopPrice -- optional/decimal -- Used with STOP_LOSS, STOP_LOSS_LIMIT,
   *                   TAKE_PROFIT, and TAKE_PROFIT_LIMIT orders. <br> newClientOrderId -- optional/string -- A unique
   *                   id among open orders. Automatically generated if not sent. <br> icebergQty -- optional/deciaml --
   *                   Used with LIMIT, STOP_LOSS_LIMIT, and TAKE_PROFIT_LIMIT to create an iceberg order. <br>
   *                   newOrderRespType -- optional/enum -- Set the response JSON. ACK, RESULT, or FULL; MARKET and
   *                   LIMIT order types default to FULL, all other orders default to ACK. <br> sideEffectType --
   *                   optional/enum -- NO_SIDE_EFFECT, MARGIN_BUY, AUTO_REPAY; default NO_SIDE_EFFECT. <br> timeInForce
   *                   -- optional/enum -- GTC,IOC,FOK <br> recvWindow -- optional/long -- The value cannot be greater
   *                   than 60000 <br>
   * @return String
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> orderId -- optional/long <br> origClientOrderId --
   *                   optional/string <br> newClientOrderId -- optional/string -- Used to uniquely identify this
   *                   cancel. Automatically generated by default. <br> recvWindow -- optional/long -- The value cannot
   *                   be greater than 60000 <br>
   * @return String
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE, default "FALSE" <br> recvWindow -- optional/long -- The value cannot be greater
   *                   than 60000 <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#margin-account-cancel-all-open-orders-on-a-symbol-trade">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string <br> type -- optional/string -- Transfer Type: ROLL_IN, ROLL_OUT <br>
   *                   startTime -- optional/long <br> endTime -- optional/long <br> current -- optional/long --
   *                   Currently querying page. Start from 1. Default:1 <br> size -- optional/long -- Default:10
   *                   Max:100
   *                   <br> archived -- optional/string -- Default: false. Set to true for archived data from 6 months
   *                   ago <br> recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string <br> isolatedSymbol -- optional/string <br> txId -- optional/long --
   *                   the tranId in POST /sapi/v1/margin/loan <br> startTime -- optional/long <br> endTime --
   *                   optional/long <br> current -- optional/long -- Currently querying page. Start from 1. Default:1
   *                   <br> size -- optional/long -- Default:10 Max:100 <br> archived -- optional/string -- Default:
   *                   false. Set to true for archived data from 6 months ago <br> recvWindow -- optional/long -- The
   *                   value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string <br> isolatedSymbol -- optional/string <br> startTime -- optional/long
   *                   <br> endTime -- optional/long <br> current -- optional/long -- Currently querying page. Start
   *                   from 1. Default:1 <br> size -- optional/long -- Default:10 Max:100 <br> archived --
   *                   optional/string -- Default: false. Set to true for archived data from 6 months ago <br>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   startTime -- optional/long <br> endTime -- optional/long <br> isolatedSymbol -- optional/string
   *                   <br> current -- optional/long -- Currently querying page. Start from 1. Default:1 <br> size --
   *                   optional/long -- Default:10 Max:100 <br> recvWindow -- optional/long -- The value cannot be
   *                   greater than 60000 <br>
   * @return String
  ...
  public String forceLiquidationRec(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, FORCE_LIQUIDATION_RECORD, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> orderId -- optional/long <br> origClientOrderId --
   *                   optional/string <br> recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- optional/string <br> isIsolated -- optional/string -- for isolated margin or not,
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> orderId -- optional/long <br> startTime -- optional/long
   *                   <br> endTime -- optional/long <br> limit -- optional/int -- Default 500; max 500. <br>
   *                   recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE",default "FALSE" <br> listClientOrderId -- optional/string -- A unique Id for the
   *                   entire orderList <br> side -- mandatory/enum <br> quantity -- mandatory/decimal <br>
   *                   limitClientOrderId -- optional/string -- A unique Id for the limit order <br> price --
   *                   mandatory/decimal <br> limitIcebergQty -- optional/decimal <br> stopClientOrderId --
   *                   optional/string -- A unique Id for the stop loss/stop loss limit leg <br> stopPrice --
   *                   optional/decimal -- Used with STOP_LOSS, STOP_LOSS_LIMIT, TAKE_PROFIT, and TAKE_PROFIT_LIMIT
   *                   orders. <br> stopLimitPrice -- optional/decimal -- If provided, stopLimitTimeInForce is
   *                   required.
   *                   <br> stopIcebergQty -- optional/enum -- NO_SIDE_EFFECT, MARGIN_BUY, AUTO_REPAY; default
   *                   NO_SIDE_EFFECT. <br> stopLimitTimeInForce -- optional/enum -- GTC,IOC,FOK <br> newOrderRespType
   *                   -- optional/enum -- Set the response JSON. <br> sideEffectType -- optional/enum --
   *                   NO_SIDE_EFFECT, MARGIN_BUY, AUTO_REPAY; default NO_SIDE_EFFECT. <br> recvWindow -- optional/long
   *                   -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   <br><br>
   *                   symbol -- mandatory/string <br> isIsolated -- optional/string -- for isolated margin or not,
   *                   "TRUE", "FALSE", default "FALSE" <br> orderListId -- optional/long -- Either orderListId or
   *                   listClientOrderId must be provided <br> listClientOrderId -- optional/string -- Either
   *                   orderListId or listClientOrderId must be provided<br> newClientOrderId -- optional/string -- Used
   *                   to uniquely identify this cancel. Automatically generated by default <br> recvWindow --
   *                   optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   listClientOrderId -- optional/string -- Either orderListId or listClientOrderId must be
   *                   provided<br> recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   startTime -- optional/long <br> endTime -- optional/long <br> limit -- optional/int -- Default
   *                   Value: 500; Max Value: 1000 <br> recvWindow -- optional/long -- The value cannot be greater than
   *                   60000 <br>
   * @return String
   ...
   *                   <br> recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   isIsolated -- optional/string -- for isolated margin or not, "TRUE", "FALSE,default "FALSE" <br>
   *                   startTime -- optional/long <br> endTime -- optional/long <br> fromId -- optional/long -- TradeId
   *                   to fetch from. Default gets most recent trades. <br> limit -- optional/int -- Default Value: 500;
   *                   Max Value: 1000 <br> recvWindow -- optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string -- asset,such as BTC <br> symbol -- mandatory/string <br> transFrom --
   *                   mandatory/string -- "SPOT", "ISOLATED_MARGIN" <br> transTo -- mandatory/string -- "SPOT",
   *                   "ISOLATED_MARGIN" <br> amount -- mandatory/decimal <br> recvWindow -- optional/long -- The value
   *                   cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- optional/string -- asset,such as BTC <br> symbol -- mandatory/string <br> transFrom --
   *                   optional/string -- "SPOT", "ISOLATED_MARGIN" <br> transTo -- optional/string -- "SPOT",
   *                   "ISOLATED_MARGIN" <br> startTime -- optional/long <br> endTime -- optional/long <br> current --
   *                   optional/long -- Current page, default 1 <br> size -- optional/decimal <br> recvWindow --
   *                   optional/long -- The value cannot be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbols -- optional/string -- Max 5 symbols can be sent; separated by ",". e.g.
   *                   "BTCUSDT,BNBUSDT,ADAUSDT" <br> recvWindow -- optional/long -- The value cannot be greater than
   *                   60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> recvWindow -- optional/long -- The value cannot be greater than
   *                   60000 <br>
   * @return String
   ...
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#query-enabled-isolated-margin-account-limit-user_data">
  ...
  public String getIsolatedAccountLimit(LinkedHashMap<String, Object> parameters) {
    return requestHandler.sendSignedRequest(baseUrl, ISOLATED_ACCOUNT_LIMIT, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   spotBNBBurn -- optional/string -- "true" or "false"; Determines whether to use BNB to pay for
   *                   trading fees on SPOT <br> interestBNBBurn -- optional/string -- "true" or "false"; Determines
   *                   whether to use BNB to pay for margin loan's interest  <br> recvWindow -- optional/long -- The
   *                   value cannot be greater than 60000 <br>
   * @return String
   * @see <a
   * href="https://binance-docs.github.io/apidocs/spot/en/#toggle-bnb-burn-on-spot-trade-and-margin-interest-user_data">
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   asset -- mandatory/string -- asset,such as BTC <br> vipLevel -- optional/int -- Default: user's
   *                   vip level <br> startTime -- optional/long -- Default: 7 days ago <br> endTime -- optional/long --
   *                   Default: present. Maximum range: 3 months. <br> recvWindow -- optional/long -- The value cannot
   *                   be greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   vipLevel -- optional/int -- 	User's current specific margin data will be returned if vipLevel is
   *                   omitted <br> coin -- optional/string <br> recvWindow -- optional/long -- The value cannot be
   *                   greater than 60000 <br>
   * @return String
   ...
   *                   <br><br>
   *                   vipLevel -- optional/int -- 	User's current specific margin data will be returned if vipLevel is
   *                   omitted <br> symbol -- optional/string <br> recvWindow -- optional/long -- The value cannot be
   *                   greater than 60000 <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   symbol -- mandatory/string <br> tier -- optional/string -- All margin tier data will be returned
   *                   if tier is omitted <br> recvWindow -- optional/long -- The value cannot be greater than 60000
   *                   <br>
   * @return String
