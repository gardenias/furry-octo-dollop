...
public class BSwap {
   ...
   *                   <br><br>
   *                   poolId -- optional/long <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   poolId -- mandatory/long <br> type -- optional/string -- "Single" to add a single token;
   *                   "Combination" to add dual tokens. Default "Single" <br> asset -- mandatory/string <br> quantity
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   poolId -- mandatory/long <br> type -- mandatory/string -- SINGLE for single asset removal,
   *                   COMBINATION for combination of all coins removal <br> asset -- optional/string <br> shareAmount
   *                   -- mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   operationId -- optional/long <br> poolId -- optional/long <br> operation -- optional/enum -- ADD
   *                   or REMOVE <br> startTime -- optional/long <br> endTime -- optional/long <br> limit --
   *                   optional/long -- default 3, max 100 <br> recvWindow -- optional/long <br>
   * @return String
   ...
   * rates.<br> quoteQty is quantity of quote asset (to sell).<br> Please be noted the quote is for reference only, the
   * actual price will change as the liquidity changes, it's recommended to swap immediate after request a quote for
   * slippage prevention.
   * <br><br>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   quoteAsset -- mandatory/string <br> baseAsset -- mandatory/string <br> quoteQty --
   *                   mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
   * @see <a href="https://binance-docs.github.io/apidocs/spot/en/#get-liquidity-operation-record-user_data">
   * https://binance-docs.github.io/apidocs/spot/en/#get-liquidity-operation-record-user_data</a>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   swapId -- optional/long <br> startTime -- optional/long <br> endTime -- optional/long <br> status
   *                   -- optional/int -- 0: pending for swap, 1: success, 2: failed <br> quoteAsset -- optional/string
   *                   <br> baseAsset -- optional/string <br> limit -- optional/long -- default 3, max 100 <br>
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   poolId -- mandatory/long <br> type -- mandatory/string -- "SINGLE" for adding a single
   *                   token;"COMBINATION" for adding dual tokens <br> quoteAsset -- mandatory/string <br> quoteQty --
   *                   mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
   ...
   *                   <br><br>
   *                   poolId -- mandatory/long <br> type -- mandatory/string -- "SINGLE" for adding a single
   *                   token;"COMBINATION" for adding dual tokens <br> quoteAsset -- mandatory/string <br> shareAmount
   *                   -- mandatory/decimal <br> recvWindow -- optional/long <br>
   * @return String
  ...
  public String removeLiquidityPreview(LinkedHashMap<String, Object> parameters) {
    ...
    ParameterChecker.checkParameter(parameters, "quoteAsset", String.class);
    ParameterChecker.checkRequiredParameter(parameters, "shareAmount");
    return requestHandler.sendSignedRequest(baseUrl, REMOVE_LIQUIDITY_PREVIEW, parameters, HttpMethod.GET,
      showLimitUsage);
  }
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   type -- optional/int -- 0: Swap rewards,1:Liquidity rewards, default to 0 <br> recvWindow --
   *                   optional/long <br>
   * @return String
   ...
   *                   value of the parameter
   *                   <br><br>
   *                   poolId -- optional/long <br> assetRewards -- optional/string <br> type -- optional/int -- 0: Swap
   *                   rewards,1:Liquidity rewards, default to 0 <br> startTime -- optional/long <br> endTime --
   *                   optional/long <br> limit -- optional/long -- Default 3, max 100 <br> recvWindow -- optional/long
   *                   <br>
   * @return String
