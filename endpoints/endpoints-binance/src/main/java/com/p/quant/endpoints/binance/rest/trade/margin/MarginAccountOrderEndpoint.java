 ...
 */
public class MarginAccountOrderEndpoint extends AbstractBinanceRESTEndpoint<AccountInfoReq, AccountInfoResp> {

    public MarginAccountOrderEndpoint(WebClient webClient, SignatureProducer signatureProducer) {
