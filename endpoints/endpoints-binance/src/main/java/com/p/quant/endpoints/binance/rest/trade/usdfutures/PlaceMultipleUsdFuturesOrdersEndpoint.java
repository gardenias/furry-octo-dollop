 ...
 */
public class PlaceMultipleUsdFuturesOrdersEndpoint extends AbstractBinanceRESTEndpoint<PlaceMultipleUsdFuturesOrdersReq, PlaceMultipleUsdFuturesOrdersResp> {

    public PlaceMultipleUsdFuturesOrdersEndpoint(WebClient webClient, SignatureProducer signatureProducer) {
        super(webClient, signatureProducer, "/fapi/v1/batchOrders", HttpMethod.POST, RequestType.SIGNED);
    }
    @Data
    ...
    @Data
    public static class PlaceMultipleUsdFuturesOrdersReq extends BinanceReq {
        private Long recvWindow;
        private Long timestamp;
        private List<Order> batchOrders;
    }
    @Data
    public static class PlaceMultipleUsdFuturesOrdersResp extends Resp {
