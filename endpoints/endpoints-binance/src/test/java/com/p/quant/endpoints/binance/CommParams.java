...
import com.p.quant.endpoints.binance.spec.impl.BinanceTradeRestSpecImpl;
...
//        signatureUsdProducer = new BinanceSignatureProducer(PrivateConfig.SPOT_API_KEY, PrivateConfig.SPOT_SECRET_KEY);
        signatureSpotProducerTest = new BinanceSignatureProducer(PrivateConfig.TESTNET_SPOT_API_KEY, PrivateConfig.TESTNET_SPOT_SECRET_KEY);
        signatureUsdProducerTest = new BinanceSignatureProducer(PrivateConfig.TESTNET_USD_API_KEY, PrivateConfig.TESTNET_USD_SECRET_KEY);
