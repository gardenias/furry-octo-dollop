...
public class OrderArchiveEndpoint extends AbstractRESTEndpoint<OrdArchiveReq, OrdArchiveResp> {

    public OrderArchiveEndpoint(WebClient webClient, HeadersProducer headersProducer) {
        super(webClient, headersProducer, "/api/v5/trade/orders-history-archive", HttpMethod.GET);
    }
    ...
    public static class OrdArchiveResp extends Resp {
    ...
    @ToString(callSuper = true)
    public static class OrdArchiveReq extends Req {
